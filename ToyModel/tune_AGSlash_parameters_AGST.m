%% RKF‑Slash 参数调优脚本 – AGST 噪声（高斯 + 学生 t）四种强度场景
% 对四个 AGST 强度场景分别扫描 n_R, n_Q, n_dof，找出使 RMSE 最小的预设参数
clear; clc; close all;
rng(2025);
...
% 保存汇总结果
save('AGSlash_best_params_AGST.mat', 'best_params', 'best_RMSE', 'AGST_cases');
fprintf('\n所有调优结果已保存至 AGSlash_best_params_AGST.mat\n');