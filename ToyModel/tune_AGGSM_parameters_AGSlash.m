%% AGSMG (RKF-AGSMG) 参数调优 – AGSlash 噪声（高斯 + Slash）
% 对四个 AGSlash 强度场景分别扫描 n_R, n_Q, n_dof
clear; clc; close all;
rng(2025);
...
save('AGGSM_best_params_AGSlash.mat', 'best_params', 'best_RMSE', 'AGSlash_cases');
fprintf('\n所有调优结果已保存至 AGGSM_best_params_AGSlash.mat\n');